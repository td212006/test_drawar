...
import com.example.test_drawar.databinding.FragmentInfoUserBinding;
...
public class InfoUserFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        InfoUserViewModel =
                new ViewModelProvider(this).get(InfoUserViewModel.class);

        binding = FragmentInfoUserBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        final TextView textView = binding.textInfoUser;
        InfoUserViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
